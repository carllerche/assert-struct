...
- migrate root changelog to per-crate changelogs ([#121](https://github.com/carllerche/assert-struct/pull/121))

## [0.4.1](https://github.com/carllerche/assert-struct/compare/assert-struct-macros-v0.4.0...assert-struct-macros-v0.4.1) - 2026-03-10

### Added

- support bare `{ ... }` as shorthand for `_ { ... }` anonymous structs ([#115](https://github.com/carllerche/assert-struct/pull/115))

### Other

- update all docs to use bare `{ ... }` anonymous struct syntax ([#116](https://github.com/carllerche/assert-struct/pull/116))

## [0.4.0](https://github.com/carllerche/assert-struct/compare/assert-struct-macros-v0.3.1...assert-struct-macros-v0.4.0) - 2026-02-22
...
## [0.3.1](https://github.com/carllerche/assert-struct/compare/assert-struct-macros-v0.3.0...assert-struct-macros-v0.3.1) - 2026-02-19

### Fixed
- **Method call regression** - Fixed E0716/E0507 errors when calling methods that return owned values or references (#105)

## [0.3.0](https://github.com/carllerche/assert-struct/compare/assert-struct-macros-v0.2.0...assert-struct-macros-v0.3.0) - 2026-02-19
...
## [0.2.0](https://github.com/carllerche/assert-struct/compare/assert-struct-macros-v0.1.0...assert-struct-macros-v0.2.0) - 2025-08-23
...
## [0.1.0](https://github.com/carllerche/assert-struct/releases/tag/assert-struct-macros-v0.1.0) - 2025-08-21
